...
const ChatInterface: React.FC = () => {
    ...
    const isProImageSelected = selectedModel === ModelType.GEMINI_3_PRO_IMAGE || selectedModel === ModelType.GEMINI_3_1_PRO_IMAGE || selectedModel === ModelType.GEMINI_3_1_FLASH_IMAGE;
