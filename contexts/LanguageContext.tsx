...
const translations = {
    en: {
        ...
        stop_btn: "Stop",
        estimate_cost_btn: "Estimate Cost",
        estimating: "Counting...",
        approx_estimate: "Approximate estimate",
        precise_estimate: "Precise estimate",
        precise_btn: "Precise",
        input_tokens: "Input tokens",
        input_cost_label: "Input cost",
        image_cost_label: "Output image cost",
        total_estimated_cost: "Total estimated cost",
        estimate_error: "Failed to estimate cost",
        ...
        api_provider_auto_desc: "Auto-detected from selected server key in user Settings",
        ...
        show_image_search: "Image Search (Grounding)",
        show_image_search_desc: "Allow Google Image Search grounding (3.1 Flash only)",
        image_search_label: "Image Search",
        image_search_tooltip: "Grounding with Google Image Search (only 3.1 Flash)",
        show_google_search: "Google Search (Grounding)",
        show_google_search_desc: "Allow Google Search grounding for all models",
        google_search_label: "Google Search",
        google_search_tooltip: "Grounding with Google Search — real-time web data",
        image_only_label: "Image Only",
        image_only_tooltip: "Force image-only output (no text). Model will always return an image",
        ...
        retry_rate_limit: "Servers overloaded, retrying...",
        retry_unavailable: "Service temporarily unavailable, retrying...",
        retry_server_error: "Server error, retrying...",
        ...
        ar_tall_vertical: "1:4 (Tall Vertical)",
        ar_wide_horizontal: "4:1 (Wide Horizontal)",
        ar_ultra_tall: "1:8 (Ultra Tall)",
        ar_ultra_wide: "8:1 (Ultra Wide)",
        res_05k: "512px (0.5K)",
        ...
        cloud_job_not_found: "Job not found on server (deleted or expired).",
        cloud_debug_title: "Job Details",
        cloud_debug_status: "Status",
        cloud_debug_model: "Model",
        cloud_debug_created: "Created",
        cloud_debug_updated: "Last Updated",
        cloud_debug_output: "Output File",
        cloud_debug_stats: "Request Stats",
        cloud_debug_stats_total: "Total",
        cloud_debug_stats_ok: "Succeeded",
        cloud_debug_stats_fail: "Failed",
        cloud_debug_error: "Error",
        cloud_debug_raw: "Raw API Response",
        cloud_debug_copy: "Copy JSON",
        cloud_debug_cached: "Showing cached local data. Job no longer exists on server.",
        ...
        cloud_status_expired: "Expired",
        cloud_default_image_job_name: "Batch_{timestamp}_Img_P{page}",
        cloud_default_text_job_name: "Batch_{timestamp}_Txt_P{page}",
        cloud_batch_500: "Up to 500",
        cloud_batch_1000: "Up to 1000",
        cloud_batch_500_desc: "Create jobs in chunks of up to 500 requests.",
        cloud_batch_1000_desc: "Create jobs in chunks of up to 1000 requests.",
        cloud_streamed_page_actions_hint: "Actions apply to all visible items (removed items are excluded).",
        cloud_zip_all_pages: "ZIP All Pages",
        cloud_save_all_pages_to_gallery: "Save All Pages",
        cloud_exclude_item: "Exclude from save/zip",
        cloud_delete_confirm: "Delete this batch job from the server?",
        cloud_delete_failed: "Failed to delete job:",
        cloud_sync_btn: "Sync with API",
        cloud_sync_success: "Synced {count} jobs from API.",
        cloud_sync_failed: "Failed to sync jobs:",
        cloud_batch_stats: "{succeeded}/{total} succeeded, {failed} failed",
        cloud_expired_hint: "Job expired after 48h. Resubmit.",
        cloud_waiting_progress: "Processing...",
        // Server API Keys
        sk_title: "Server API Keys",
        sk_description: "Manage API keys stored on the server. Assign access to specific users. Keys are never exposed in the browser.",
        sk_existing_keys: "Registered Keys",
        sk_no_keys: "No server keys configured yet.",
        sk_add_key: "Add New Key",
        sk_edit_key: "Edit Key",
        sk_provider: "Provider",
        sk_label: "Label",
        sk_label_placeholder: "e.g. Main Production Key",
        sk_key_value: "API Key",
        sk_leave_empty: "leave empty to keep current",
        sk_allowed_users: "Allowed Users",
        sk_enabled: "Active",
        ...
        sk_access: "Access",
        sk_add_btn: "Add Key",
        sk_delete_confirm: "Delete this server key?",
        sk_label_required: "Label is required",
        sk_key_required: "API key value is required",
        sk_save_failed: "Failed to save key",
        sk_local_keys_title: "Personal API Keys (Local)",
        sk_local_keys_desc: "These keys are stored in your browser only and are used as a fallback if no server key is selected.",
        sk_use_own_key: "Use my own key",
        sk_enter_own_key: "Paste your API Key here...",
        sk_select_failed: "Failed to activate server key. Try again.",
        all_users: "All Users",
        loading: "Loading",
        ...
        sign_out: "Sign Out",
        remove_saved_account: "Remove saved account",
        switch_account_failed: "Failed to switch account. The account may have been deleted.",
        enter_password_for: "Enter password for",
        login_subtitle: "GenAI Studio Access",
        login_add_account_subtitle: "Sign in with another account",
        ...
        login_restricted_access: "Restricted Access System",
    },
    ru: {
        ...
        stop_btn: "Стоп",
        estimate_cost_btn: "Оценить стоимость",
        estimating: "Подсчёт...",
        approx_estimate: "Примерная оценка",
        precise_estimate: "Точная оценка",
        precise_btn: "Точнее",
        input_tokens: "Входные токены",
        input_cost_label: "Стоимость ввода",
        image_cost_label: "Стоимость изображения",
        total_estimated_cost: "Итого (оценка)",
        estimate_error: "Не удалось оценить стоимость",
        ...
        api_provider_auto_desc: "Автоматически определяется по выбранному серверному ключу в Настройках",
        ...
        show_image_search: "Поиск изображений (Grounding)",
        show_image_search_desc: "Разрешить Google Image Search для заземления (только 3.1 Flash)",
        image_search_label: "Image Search",
        image_search_tooltip: "Поиск изображений Google для контекста (только 3.1 Flash)",
        show_google_search: "Google Search (Grounding)",
        show_google_search_desc: "Разрешить заземление через поиск Google для всех моделей",
        google_search_label: "Google Search",
        google_search_tooltip: "Заземление через Google Search — актуальные данные из веба",
        image_only_label: "Только фото",
        image_only_tooltip: "Принудительный вывод только изображения (без текста). Модель всегда вернёт картинку",
        ...
        tok: "ток.",
        model: "Модель",
        models_breakdown: "Модели",
        rub_rate: "Курс USD → RUB",
        retry_rate_limit: "Серверы перегружены, повтор...",
        retry_unavailable: "Сервис временно недоступен, повтор...",
        retry_server_error: "Ошибка сервера, повтор...",
        ...
        ar_tall_vertical: "1:4 (Узкий вертикальный)",
        ar_wide_horizontal: "4:1 (Широкий горизонтальный)",
        ar_ultra_tall: "1:8 (Ультра узкий)",
        ar_ultra_wide: "8:1 (Ультра широкий)",
        res_05k: "512px (0.5K)",
        ...
        cloud_job_not_found: "Задача не найдена на сервере (удалена или истекла).",
        cloud_debug_title: "Детали задачи",
        cloud_debug_status: "Статус",
        cloud_debug_model: "Модель",
        cloud_debug_created: "Создана",
        cloud_debug_updated: "Обновлена",
        cloud_debug_output: "Файл результатов",
        cloud_debug_stats: "Статистика запросов",
        cloud_debug_stats_total: "Всего",
        cloud_debug_stats_ok: "Успешно",
        cloud_debug_stats_fail: "С ошибкой",
        cloud_debug_error: "Ошибка",
        cloud_debug_raw: "Сырой ответ API",
        cloud_debug_copy: "Копировать JSON",
        cloud_debug_cached: "Показаны кэшированные данные. Задача больше не существует на сервере.",
        ...
        cloud_status_expired: "Истекло",
        cloud_default_image_job_name: "Пакет_{timestamp}_Изоб_Ч{page}",
        cloud_default_text_job_name: "Пакет_{timestamp}_Текст_Ч{page}",
        cloud_batch_500: "До 500",
        cloud_batch_1000: "До 1000",
        cloud_batch_500_desc: "Задачи создаются пачками до 500 запросов.",
        cloud_batch_1000_desc: "Задачи создаются пачками до 1000 запросов.",
        cloud_streamed_page_actions_hint: "Действия применяются ко всем видимым элементам (удалённые исключаются).",
        ...
        cloud_delete_confirm: "Удалить эту batch-задачу с сервера?",
        cloud_delete_failed: "Не удалось удалить задачу:",
        cloud_sync_btn: "Синхронизация с API",
        cloud_sync_success: "Синхронизировано {count} задач из API.",
        cloud_sync_failed: "Ошибка синхронизации:",
        cloud_batch_stats: "{succeeded}/{total} успешно, {failed} ошибок",
        cloud_expired_hint: "Задача истекла после 48ч. Отправьте заново.",
        cloud_waiting_progress: "Обработка...",
        // Server API Keys
        sk_title: "Серверные API ключи",
        sk_description: "Управление API ключами, хранящимися на сервере. Назначайте доступ конкретным пользователям. Ключи не отображаются в браузере.",
        sk_existing_keys: "Зарегистрированные ключи",
        sk_no_keys: "Серверные ключи ещё не настроены.",
        sk_add_key: "Добавить ключ",
        sk_edit_key: "Редактировать ключ",
        sk_provider: "Провайдер",
        sk_label: "Название",
        sk_label_placeholder: "напр. Основной рабочий ключ",
        sk_key_value: "API ключ",
        sk_leave_empty: "оставьте пустым, чтобы не менять",
        sk_allowed_users: "Разрешённые пользователи",
        sk_enabled: "Активен",
        sk_disabled: "Отключён",
        sk_enable: "Включить",
        sk_disable: "Отключить",
        sk_access: "Доступ",
        sk_add_btn: "Добавить ключ",
        sk_delete_confirm: "Удалить этот серверный ключ?",
        sk_label_required: "Название обязательно",
        sk_key_required: "Значение API ключа обязательно",
        sk_save_failed: "Не удалось сохранить ключ",
        sk_local_keys_title: "Персональные API ключи (Локальные)",
        sk_local_keys_desc: "Эти ключи хранятся только в вашем браузере и используются, если серверный ключ не выбран.",
        sk_use_own_key: "Использовать свой ключ",
        sk_enter_own_key: "Вставьте ваш API ключ...",
        sk_select_failed: "Не удалось активировать серверный ключ. Попробуйте снова.",
        ...
        sign_out: "Выйти",
        remove_saved_account: "Удалить сохранённый аккаунт",
        switch_account_failed: "Не удалось переключить аккаунт. Возможно, он был удалён.",
        enter_password_for: "Введите пароль для",
        login_subtitle: "Доступ к GenAI Студии",
        login_add_account_subtitle: "Войти под другим аккаунтом",
        ...
        login_sign_in: "Войти",
        login_invalid_credentials: "Неверные учётные данные",
        login_restricted_access: "Система с ограниченным доступом",
    }
};
